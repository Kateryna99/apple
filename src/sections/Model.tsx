...
import { models } from "../constants/sections/models";
import { sizes } from "../constants/sections/sizes";
...
const Model = () => {
  ...
  const cameraControlSmall = useRef<THREE.Camera>(null);
  const cameraControlLarge = useRef<THREE.Camera>(null);
